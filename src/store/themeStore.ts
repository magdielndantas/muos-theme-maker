...
export type ScreenScheme = {
  ...
  CELL_WIDTH: number;
  CELL_HEIGHT: number;
  CELL_DEFAULT_BACKGROUND: string;
  ...
  LIST_DEFAULT_INDICATOR: string;
  LIST_DEFAULT_RADIUS: number;
  LIST_DEFAULT_GRADIENT_START: number;
  LIST_DEFAULT_GRADIENT_STOP: number;
  LIST_DEFAULT_GRADIENT_DIRECTION: number;
  LIST_DEFAULT_BORDER_WIDTH: number;
  LIST_DEFAULT_BORDER_SIDE: number;
  LIST_DEFAULT_LABEL_LONG_MODE: number;
  ...
  LIST_FOCUS_INDICATOR: string;
  LIST_FOCUS_GRADIENT_START: number;
  LIST_FOCUS_GRADIENT_STOP: number;
  LIST_FOCUS_GRADIENT_DIRECTION: number;
  LIST_FOCUS_BORDER_WIDTH: number;
  LIST_FOCUS_BORDER_SIDE: number;

  // Roll (Scroll Picker)
  ROLL_TEXT: string;
  ROLL_TEXT_ALPHA: number;
  ROLL_BACKGROUND: string;
  ROLL_BACKGROUND_ALPHA: number;
  ROLL_RADIUS: number;
  ROLL_SELECT_TEXT: string;
  ROLL_SELECT_TEXT_ALPHA: number;
  ROLL_SELECT_BACKGROUND: string;
  ROLL_SELECT_BACKGROUND_ALPHA: number;
  ROLL_SELECT_RADIUS: number;
  ROLL_BORDER_COLOUR: string;
  ROLL_BORDER_ALPHA: number;
  ROLL_BORDER_RADIUS: number;

  // Counter
  COUNTER_BORDER_COLOUR: string;
  COUNTER_BACKGROUND_GRADIENT: string;

  // Images
  IMAGE_LIST_ALPHA: number;
  IMAGE_LIST_PAD_TOP: number;
  IMAGE_LIST_PAD_BOTTOM: number;
  IMAGE_LIST_PAD_LEFT: number;
  IMAGE_LIST_PAD_RIGHT: number;
  IMAGE_LIST_RADIUS: number;
  IMAGE_LIST_RECOLOUR: string;
  IMAGE_LIST_RECOLOUR_ALPHA: number;
  IMAGE_PREVIEW_ALPHA: number;
  IMAGE_PREVIEW_RADIUS: number;
  IMAGE_PREVIEW_RECOLOUR: string;
  ...
  GRID_COLUMN_WIDTH: number;
  GRID_ROW_HEIGHT: number;
  GRID_COLUMN_PADDING: number;
  GRID_ROW_PADDING: number;
...
export const DEFAULT_SCHEME: ScreenScheme = {
  ...
  LIST_DEFAULT_RADIUS: 0,
  LIST_DEFAULT_GRADIENT_START: 0,
  LIST_DEFAULT_GRADIENT_STOP: 0,
  LIST_DEFAULT_GRADIENT_DIRECTION: 0,
  LIST_DEFAULT_BORDER_WIDTH: 5,
  LIST_DEFAULT_BORDER_SIDE: 4,
  ...
  CELL_WIDTH: 200,
  CELL_HEIGHT: 200,
  CELL_DEFAULT_BACKGROUND: "C69200",
  ...
  IMAGE_LIST_PAD_TOP: 0,
  IMAGE_LIST_PAD_BOTTOM: 10,
  IMAGE_LIST_PAD_LEFT: 0,
  ...
  GRID_LOCATION_X: 40,
  GRID_LOCATION_Y: 40,
  GRID_COLUMN_WIDTH: 157,
  GRID_ROW_HEIGHT: 162,
  GRID_COLUMN_PADDING: 0,
  GRID_ROW_PADDING: 0,
  GRID_ALIGNMENT: 0,
  GRID_ACTIVE: 0,
  GRID_ROW_COUNT: 0,
  ...
  ROLL_BORDER_COLOUR: "100808",
  ROLL_BORDER_ALPHA: 255,
  ROLL_BORDER_RADIUS: 255,

  COUNTER_BORDER_COLOUR: "100808",
  COUNTER_BACKGROUND_GRADIENT: "100808",
...
interface ThemeState {
  ...
  setThemeCredits: (credits: string) => void;

...
export const exportTheme = async (themeName: string = "MyTheme") => {
  ...
  zip.file(`${themeName}/active.txt`, state.themeName || themeName);
  zip.file(`${themeName}/name.txt`, state.themeName || themeName);
  zip.file(`${themeName}/credits.txt`, state.themeCredits || `Theme: ${themeName}\nCreated with muOS Theme Studio`);
  zip.file(`${themeName}/version.txt`, state.themeVersion || "1.0");
...
function buildIniContent(overrides: Partial<ScreenScheme> = {}): string {
  ...
  const sectionMapping: Record<string, (keyof ScreenScheme)[]> = {
    ...
    animation: ["ANIMATION_DELAY", "ANIMATION_REPEAT"],
    ...
    counter: ["COUNTER_ALIGNMENT", "COUNTER_BACKGROUND", "COUNTER_BACKGROUND_ALPHA", "COUNTER_BORDER_ALPHA", "COUNTER_BORDER_COLOUR", "COUNTER_BORDER_WIDTH", "COUNTER_ENABLED", "COUNTER_PADDING_AROUND", "COUNTER_PADDING_SIDE", "COUNTER_PADDING_TOP", "COUNTER_RADIUS", "COUNTER_TEXT", "COUNTER_TEXT_ALPHA", "COUNTER_TEXT_FADE_TIME", "COUNTER_TEXT_SEPARATOR"],
    date: ["DATETIME_ALIGN", "DATETIME_TEXT", "DATETIME_ALPHA", "DATETIME_PADDING_LEFT", "DATETIME_PADDING_RIGHT"],
    font: ["FONT_FOOTER_ICON_PAD_BOTTOM", "FONT_FOOTER_ICON_PAD_TOP", "FONT_FOOTER_PAD_BOTTOM", "FONT_FOOTER_PAD_TOP", "FONT_HEADER_ICON_PAD_BOTTOM", "FONT_HEADER_ICON_PAD_TOP", "FONT_HEADER_PAD_BOTTOM", "FONT_HEADER_PAD_TOP", "FONT_LIST_ICON_PAD_BOTTOM", "FONT_LIST_ICON_PAD_TOP", "FONT_LIST_PAD_BOTTOM", "FONT_LIST_PAD_LEFT", "FONT_LIST_PAD_RIGHT", "FONT_LIST_PAD_TOP", "FONT_MESSAGE_ICON_PAD_BOTTOM", "FONT_MESSAGE_ICON_PAD_TOP", "FONT_MESSAGE_PAD_BOTTOM", "FONT_MESSAGE_PAD_TOP"],
    ...
    image_list: ["IMAGE_LIST_ALPHA", "IMAGE_LIST_PAD_TOP", "IMAGE_LIST_PAD_BOTTOM", "IMAGE_LIST_PAD_LEFT", "IMAGE_LIST_PAD_RIGHT", "IMAGE_LIST_RADIUS", "IMAGE_LIST_RECOLOUR", "IMAGE_LIST_RECOLOUR_ALPHA", "IMAGE_PREVIEW_ALPHA", "IMAGE_PREVIEW_RADIUS", "IMAGE_PREVIEW_RECOLOUR", "IMAGE_PREVIEW_RECOLOUR_ALPHA"],
    ...
    list: ["LIST_DEFAULT_BACKGROUND_ALPHA", "LIST_DEFAULT_GLYPH_ALPHA", "LIST_DEFAULT_GLYPH_PAD_LEFT", "LIST_DEFAULT_GLYPH_RECOLOUR", "LIST_DEFAULT_GLYPH_RECOLOUR_ALPHA", "LIST_DEFAULT_INDICATOR", "LIST_DEFAULT_INDICATOR_ALPHA", "LIST_DEFAULT_RADIUS", "LIST_DEFAULT_TEXT", "LIST_DEFAULT_TEXT_ALPHA", "LIST_DEFAULT_GRADIENT_START", "LIST_DEFAULT_GRADIENT_STOP", "LIST_DEFAULT_GRADIENT_DIRECTION", "LIST_DEFAULT_BORDER_WIDTH", "LIST_DEFAULT_BORDER_SIDE", "LIST_DEFAULT_LABEL_LONG_MODE", "LIST_DISABLED_TEXT", "LIST_DISABLED_TEXT_ALPHA", "LIST_FOCUS_BACKGROUND", "LIST_FOCUS_BACKGROUND_ALPHA", "LIST_FOCUS_GLYPH_ALPHA", "LIST_FOCUS_GLYPH_RECOLOUR", "LIST_FOCUS_GLYPH_RECOLOUR_ALPHA", "LIST_FOCUS_INDICATOR", "LIST_FOCUS_INDICATOR_ALPHA", "LIST_FOCUS_TEXT", "LIST_FOCUS_TEXT_ALPHA", "LIST_FOCUS_GRADIENT_START", "LIST_FOCUS_GRADIENT_STOP", "LIST_FOCUS_GRADIENT_DIRECTION", "LIST_FOCUS_BORDER_WIDTH", "LIST_FOCUS_BORDER_SIDE"],
    meta: ["META_CUT"],
    misc: ["ANIMATED_BACKGROUND", "RANDOM_BACKGROUND", "ANTIALIASING", "CONTENT_PADDING_LEFT", "CONTENT_PADDING_TOP", "CONTENT_SIZE_TO_CONTENT", "CONTENT_HEIGHT", "CONTENT_WIDTH", "CONTENT_ALIGNMENT", "IMAGE_OVERLAY", "MISC_NAVIGATION_TYPE", "STATIC_ALIGNMENT"],
    navigation: ["NAVIGATION_ALIGNMENT", "NAV_SPACING", "NAV_LR_GLYPH", "NAV_LR_GLYPH_ALPHA", "NAV_LR_TEXT", "NAV_LR_TEXT_ALPHA", "NAV_UD_GLYPH", "NAV_UD_GLYPH_ALPHA", "NAV_UD_TEXT", "NAV_UD_TEXT_ALPHA", "NAV_A_GLYPH", "NAV_A_GLYPH_ALPHA", "NAV_A_TEXT", "NAV_A_TEXT_ALPHA", "NAV_B_GLYPH", "NAV_B_GLYPH_ALPHA", "NAV_B_TEXT", "NAV_B_TEXT_ALPHA", "NAV_C_GLYPH", "NAV_C_GLYPH_ALPHA", "NAV_C_TEXT", "NAV_C_TEXT_ALPHA", "NAV_MENU_GLYPH", "NAV_MENU_GLYPH_ALPHA", "NAV_MENU_TEXT", "NAV_MENU_TEXT_ALPHA", "NAV_X_GLYPH", "NAV_X_GLYPH_ALPHA", "NAV_X_TEXT", "NAV_X_TEXT_ALPHA", "NAV_Y_GLYPH", "NAV_Y_GLYPH_ALPHA", "NAV_Y_TEXT", "NAV_Y_TEXT_ALPHA", "NAV_Z_GLYPH", "NAV_Z_GLYPH_ALPHA", "NAV_Z_TEXT", "NAV_Z_TEXT_ALPHA"],
    ...
    roll: ["ROLL_TEXT", "ROLL_TEXT_ALPHA", "ROLL_BACKGROUND", "ROLL_BACKGROUND_ALPHA", "ROLL_RADIUS", "ROLL_SELECT_TEXT", "ROLL_SELECT_TEXT_ALPHA", "ROLL_SELECT_BACKGROUND", "ROLL_SELECT_BACKGROUND_ALPHA", "ROLL_SELECT_RADIUS", "ROLL_BORDER_COLOUR", "ROLL_BORDER_ALPHA", "ROLL_BORDER_RADIUS"],
    ...
    for (const key of keys) {
      if (overrides[key] !== undefined && overrides[key] !== null) {
        ...
        if (section === "header") {
          ...
          if (key === "NAV_SPACING") outKey = "SPACING";
        } else if (section === "terminal") {
          if (key === "TERMINAL_BACKGROUND") outKey = "BACKGROUND";
          if (key === "TERMINAL_FOREGROUND") outKey = "FOREGROUND";
        } else if (section === "counter") {
          if (key === "COUNTER_BORDER_COLOUR") outKey = "BORDER_COLOUR";
          if (key === "COUNTER_BACKGROUND_GRADIENT") outKey = "BACKGROUND_GRADIENT";
        }
